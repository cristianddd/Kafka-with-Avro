...
public class Address extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2738745830209216286L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Address\",\"namespace\":\"com.example.kafka_schema_registry\",\"fields\":[{\"name\":\"street\",\"type\":\"string\"},{\"name\":\"city\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.kafka_schema_registry.Address.Builder newBuilder() {
    return new com.example.kafka_schema_registry.Address.Builder();
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static com.example.kafka_schema_registry.Address.Builder newBuilder(com.example.kafka_schema_registry.Address.Builder other) {
    return new com.example.kafka_schema_registry.Address.Builder(other);
  }
   ...
   * @return A new Address RecordBuilder
   */
  public static com.example.kafka_schema_registry.Address.Builder newBuilder(com.example.kafka_schema_registry.Address other) {
    return new com.example.kafka_schema_registry.Address.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Address>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.kafka_schema_registry.Address.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.kafka_schema_registry.Address other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.street)) {
        this.street = data().deepCopy(fields()[0].schema(), other.street);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_schema_registry.Address.Builder setStreet(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_schema_registry.Address.Builder clearStreet() {
      street = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_schema_registry.Address.Builder setCity(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.kafka_schema_registry.Address.Builder clearCity() {
      city = null;
